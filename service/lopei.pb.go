...
type CheckBalanceMessage struct {
	...
	LopeiId string `protobuf:"bytes,1,opt,name=lopeiId,proto3" json:"lopeiId,omitempty"`
}
...
func (x *CheckBalanceMessage) GetLopeiId() string {
	if x != nil {
		return x.LopeiId
	}
	return ""
...
func (x *PaymentMessage) GetLopeiId() string {
	if x != nil {
		return x.LopeiId
	}
	return ""
...
func (x *PaymentMessage) GetAmount() float64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
var file_model_lopei_proto_rawDesc = []byte{
	...
	0x18, 0x0a, 0x07, 0x6c, 0x6f, 0x70, 0x65, 0x69, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	...
	0x6f, 0x70, 0x65, 0x69, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6c, 0x6f,
	0x70, 0x65, 0x69, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x35, 0x0a,
