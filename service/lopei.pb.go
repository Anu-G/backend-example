...
func (x *CheckBalanceMessage) GetPhoneNumber() string {
	if x != nil {
...
func (x *PaymentMessage) GetPhoneNumber() string {
	if x != nil {
		return x.PhoneNumber
	}
	return ""
...
var file_model_lopei_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x03, 0x61, 0x70, 0x69, 0x22, 0x37, 0x0a, 0x13, 0x43, 0x68, 0x65, 0x63,
	...
	0x72, 0x22, 0x4a, 0x0a, 0x0e, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x73, 0x73,
